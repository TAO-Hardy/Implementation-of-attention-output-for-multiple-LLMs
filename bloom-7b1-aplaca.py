...
dir_name = 'result/bloomz-7b1-stanford-alpaca-v2'
model_dir = "bloomz-7b1-stanford-alpaca-v2"

tokenizer = AutoTokenizer.from_pretrained(model_dir)
model = AutoModelForCausalLM.from_pretrained(model_dir, ignore_mismatched_sizes=True, output_attentions=True)
