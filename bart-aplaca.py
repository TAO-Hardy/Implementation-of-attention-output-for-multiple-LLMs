...
dir_name = 'result_0927/bart-large-instructiongen-w-inputs'
model_dir = "bart-large-instructiongen-w-inputs"

tokenizer = BartTokenizer.from_pretrained(model_dir)
model = BartForConditionalGeneration.from_pretrained(model_dir, output_attentions=True, add_cross_attention=True)
model.eval()
...
if __name__ == '__main__':
    ...
    for question in questions:
        for context in contexts:
            ...
            attention_cross = attentions[0:s, s:e]
