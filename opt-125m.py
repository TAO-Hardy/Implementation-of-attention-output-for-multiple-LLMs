...
dir_name = 'result_0927/LongForm-OPT-125M'
model_dir = "LongForm-OPT-125M"

tokenizer = AutoTokenizer.from_pretrained(model_dir)
model = AutoModelForCausalLM.from_pretrained(model_dir, output_attentions=True, trust_remote_code=True)
...
if __name__ == '__main__':
    ...
    for question in questions:
        for context in contexts:
            ...
            outputs = model(token, output_attentions=True)
